...
$_lang['setting_mxapi.providers'] = 'Endpoint providers';
$_lang['setting_mxapi.providers_desc'] = 'Comma separated classes implementing MxApi\\Core\\Provider\\ProviderInterface. Packages usually register via the mxApiOnRegisterEndpoints event instead.';
$_lang['setting_mxapi.middleware'] = 'Middleware';
$_lang['setting_mxapi.middleware_desc'] = 'Extra request handlers (MxApi\\Core\\Middleware\\MiddlewareInterface), comma separated. Rate limiting and idempotency are always on.';
